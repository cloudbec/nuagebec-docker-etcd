...
export ETH0_IPv4=`ip -o -4 addr show | awk -F '[ /]+' '/global/ {print $4}' | head -n1`
...
then
    ...
    then
        ...
        etcd -name `hostname` -listen-client-urls  http://$ETH0_IPV4:2379,http://$ETH0_IPV4:4001 -advertise-client-urls http://$ETH0_IPv4:2379,http://$ETH0_IPv4:4001  -listen-peer-urls http://$ETH0_IPV4:2380 -initial-advertise-peer-urls http://$ETH0_IPV4:2380
